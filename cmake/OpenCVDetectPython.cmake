...
function(find_python min_version
  ...
  set(${version_string} "${_version_string}")
  set(${version_major} "${_version_major}")
  set(${version_minor} "${_version_minor}")
  set(${libs_found} "${_libs_found}")
  set(${libs_version_string} "${_libs_version_string}")
  set(${libraries} "${_libraries}")
  set(${include_dirs} "${_include_dirs}")
  set(${packages_path} "${_packages_path}")
  set(${numpy_include_dirs} ${_numpy_include_dirs})
  set(${numpy_version} "${_numpy_version}")
